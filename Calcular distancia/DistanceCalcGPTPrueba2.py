...
# Este código es el intento de completitud del código incompleto DistanceCalc.py
# El código está diseñado para calcular la distancia entre un objeto y la cámara
# Convierte la imagen a escala de grises y detecta bordes para encontrar objetos (método no tan eficaz)