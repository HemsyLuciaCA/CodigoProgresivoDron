...
DISTANCE_BOUNDS = (50.0, 60.0)  # Distancia deseada al objeto (en cm)
...
#stream_url = "http://192.168.8.121:8080/stream.mjpeg?clientId=vsPItRLdFvff1Rt3"
...
while ret:
    ...
    #frame = cv2.resize(frame, (2*480, 2*288))
    frame = cv2.resize(frame, (240*3, 144*3))
